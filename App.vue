		...
		methods: {
			...
			wx() {
				...
				window.location.href =
					`https://open.weixin.qq.com/connect/oauth2/authorize?appid=${appid}&redirect_uri=${uri}&response_type=code&scope=${scope}&state=h5wxlogin#wechat_redirect`;
			},
			...
			downWgt(newVersion) {
				...
				plus.nativeUI.confirm("应用有新版本，是否立即下载更新？", function(event) {
					if (event.index == 1) {
						...
						plus.downloader.createDownload(newVersion, {
